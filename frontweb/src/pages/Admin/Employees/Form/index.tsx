            ...
            <div className="col employee-crud-inputs-left-container">
              ...
              <div className="margin-bottom-30">
                <input
                  ...
                  type="text"
                  className={`form-control base-input-form ${errors.name ? 'is-invalid' : ''}`}
                  placeholder="name"
                  data-testid="name"
                />
                <div className="invalid-feedback d-block base-card-invalid-feedback">{errors.name?.message}</div>
              </div>
